...
import type { Route } from "./+types/booking-request";
...
export default function Page() {
  ...
  return (
    <div className="bg-[#F8FAFB]">
      <Header title={t("booking_request.title")} />
          ...
          >
            ...
            <div className="flex flex-col">
              <p className="text-base text-[#222222] mb-2">
                {t("booking_request.names.default")}
              </p>
              <div
                className={cn(
              ...
              >
                <p className="text-sm font-light">
                  {t("booking_request.locations.pickup")}
                </p>
                <HiArrowSmallRight
                  className={cn(
                ...
                />
                <p className="text-sm font-light">
                  {t("booking_request.locations.drop")}
                </p>
              </div>
              <p className="text-xs font-light inline-flex gap-4">
                <span>{t("booking_request.date")}</span>
                <span>{t("booking_request.time")}</span>
              </p>
            </div>
            <Button
